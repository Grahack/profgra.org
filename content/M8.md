...
- séquenceur très très puissant :
  ...
  - concept de « groove » : la durée de chacun des 16 pas d’une phrase peut être redéfinie sur la timeline pour par exemple :
...
- Piste 1 pour kick (chaines 1X ou 9X)
- Piste 2 pour caisses claires (chaines 2X ou AX)
- Piste 3 pour charleys (chaines 3X ou BX)
- Piste 4 pour cymbales ou percus (chaines 4X ou CX)
- Piste 5 pour des percus additionnelles (chaines 5X ou DX)
- Piste 6 pour la basse (Chaines 6X ou EX)
- Chaine 00 pour un count-in, 0X pour un silence de X phrases
- Chaine FE pour la fin, FX pour des FX sans notes (automation ou téléportations)